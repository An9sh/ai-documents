          ...
          <>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              {requirements.map((requirement) => {
                ...
                return (
                  <Disclosure as="div" key={requirement.id} defaultOpen={true} className="bg-white shadow rounded-lg overflow-visible">
                    {({ open }: { open: boolean }) => (
                        ...
                        <div className="w-full px-4 py-3 flex items-center justify-between" 
                          ...
                          <div className="flex items-center space-x-2 ml-4">
                            ...
                            <button
                              ...
                              className="inline-flex items-center rounded-md bg-white px-2.5 py-1.5 text-sm font-medium text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 disabled:opacity-50 relative group"
                            >
                              ...
                              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 delay-100 w-64 pointer-events-none z-[100]">
                                Analyzes all documents against this requirement using AI and vector matching. Shows matched documents with confidence scores and match reasons.
                            ...
                            {requirementClassifications.length > 0 && (
                              <button
                                ...
                                className="inline-flex items-center rounded-md bg-white px-2.5 py-1.5 text-sm font-medium text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 relative group"
                              >
                                <ArrowDownTrayIcon className="h-4 w-4" />
                                <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 delay-100 w-64 pointer-events-none z-[100]">
                                  Downloads a CSV file containing all matched documents with their scores, confidence levels, match reasons, and other details.
                                  <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-1/2 rotate-45 w-2 h-2 bg-gray-900"></div>
                                </div>
                              </button>
                            )}
