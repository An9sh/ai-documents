...
//       let dbDocument: any; // Declare at outer scope
...
//         await sendProgressUpdate(uploadId, {
//           status: 'processing',
//           message: 'Processing document and uploading to Pinecone...',
//           progress: 20
//         });
...
//         await sendProgressUpdate(uploadId, {
//           status: 'error',
//           message: 'Failed to process document and upload to Pinecone',
//           progress: 0
//         });
...
//           progress: 40
//         });
//         dbDocument = await createDocument({
//           id: documentId,
//           filename: file.name,
//           fileKey: documentId,
//           type: 'document',
...
//           progress: 0
//         });
//         throw new Error(`Document metadata save failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
//       }

//       // Wait for document to be fully indexed in Pinecone
//       try {
//         await sendProgressUpdate(uploadId, {
//           status: 'processing',
//           message: 'Waiting for document to be indexed...',
//           progress: 50
//         });
//         await new Promise(resolve => setTimeout(resolve, 2000));
//       } catch (error) {
//         console.error('Error waiting for document indexing:', error);
//         await sendProgressUpdate(uploadId, {
//           status: 'error',
//           message: 'Failed while waiting for document indexing',
//           progress: 0
//         });
//         throw new Error(`Document indexing wait failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
//       }
...
//               progress: 50 + (40 * (allRequirements.indexOf(req) / allRequirements.length))
//             });
...
//           progress: 0
//         });
//         throw new Error(`Requirements processing failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
//       }
//     } catch (error) {
